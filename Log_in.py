...
class Window_1:
    def __init__(self, master):
        ...
        self.Frame = Frame(self.master, bg = 'ivory2')
        self.Frame.pack()
        ...
        self.Lbl_Title = Label(self.Frame, text = 'ShivSatish Hotel', font = ('arial',45,'bold'), bg = 'ivory2', fg = 'Black')
        self.Lbl_Title.grid(row = 0, column = 0, columnspan =3, pady = 40)
        
        self.Login_Frame_1 = LabelFrame(self.Frame, width = 1350, height = 600, relief = 'ridge', bg = 'ivory2', bd = 15,
                                        font = ('arial',20,'bold'))
        self.Login_Frame_1.grid(row = 1, column =0)
        self.Login_Frame_2 = LabelFrame(self.Frame, width = 1000, height = 600, relief = 'ridge',bg = 'ivory2', bd = 15,
                                        font = ('arial',20,'bold'))
        self.Login_Frame_2.grid(row = 2, column = 0)


        #===================================================LABEL and ENTRIES=======================================================================
        self.Label_Username = Label(self.Login_Frame_1, text = 'Username', font = ('arial',20,'bold'), bg = 'ivory2', bd = 20)
        ...
        self.Label_Password = Label(self.Login_Frame_1, text = 'Password', font = ('arial',20,'bold'), bg = 'ivory2', bd = 20)
    ...
    def Login(self):
        ...
        if (u == str('SHIVSATISH') and p == str(12345678)):
            self.__menu__()
        else:
